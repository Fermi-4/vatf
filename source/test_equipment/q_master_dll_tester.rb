...
a = TestEquipment::QMasterDriver.new(QMasterInfo.new, "C:\\qmaster_log.txt")
#:ref_file, 
#:test_file, 
#:transmitter_ip, 
#:transmitter_mask, 
...
a.wait_for_analog_test_ack(120000)
	puts "mean scores"
...
a.file_to_file_test("c:/Video_tools/cablenews_320x240_420p_511frames_768000bps_test.avi","c:/Video_tools/cablenews_320x240_420p_511frames_768000bps_test.avi")
	...
	puts a.get_blocking_scores
	puts a.get_blurring_scores
	puts a.get_frames_lost_count[2]
	puts a.get_psnr_scores
...
a.wait_for_ack(120000)
#=end
#=begin Uncomment this section to test q-master's codecs
a.mpeg4_decode_file("C:\\Video_tools\\amelie_8_720x480_420p_252frames_4000000bps.mpeg4","C:\\Video_tools\\amelie_8_720x480_420p_252frames_4000000bps_qm_dll_ruby.yuv")
