...
include Log4r
  ...
  class ApcPowerController
    ...
    def get_status(pow_address)
      ...
      #send_cmd("1")
      ret = /\bState\s+:\s+\bON/.match(@response) ? "Extron USB Switch is Connected"
    ...
    # 
    # Turns ON the equipment at the specified address   (Network Management Card AOS   v3.3.4/Rack PDU APP   v3.3.3) 
