...
module Equipment
  class LinuxEquipmentDriver < EquipmentDriver
    ...
    {
     'dm355'  => 'console=ttyS0,115200n8 noinitrd mem=116M davinci_enc_mngr.ch0_mode=NTSC davinci_enc_mngr.ch0_output=COMPOSITE',
     'dm355-evm'  => 'console=ttyS0,115200n8 noinitrd mem=116M davinci_enc_mngr.ch0_mode=NTSC davinci_enc_mngr.ch0_output=COMPOSITE',
     'dm365'  => 'console=ttyS0,115200n8 noinitrd mem=80M video=davincifb:vid0=OFF:vid1=OFF:osd0=720x576x16,4050K dm365_imp.oper_mode=0 davinci_capture.device_type=4',
     ...
     'am180x-evm'  => 'console=ttyS2,115200n8 noinitrd earlyprintk ',
     'am181x-evm'  => 'console=ttyS2,115200n8 noinitrd ',
     'da850-omapl138-evm'  => 'console=ttyS2,115200n8 noinitrd mem=32M ',
     'am3517-evm'  => 'console=ttyO2,115200n8 noinitrd earlyprintk ',
    ...
    def poweroff(params)
      send_cmd("sync;poweroff",/reboot:\s*System halted/i,120)
    end
