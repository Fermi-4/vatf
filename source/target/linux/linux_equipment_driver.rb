...
module Equipment
  class LinuxEquipmentDriver < EquipmentDriver
    ...
    @@boot_info = Hash.new('console=ttyO0,115200n8 ').merge(
    {
     ...
     'j721e-evm-ivi' => 'console=ttyS2,115200n8 earlyprintk=serial,ttyS2,115200n8 earlycon=ns16550a,mmio32,0x02800000 rootwait fsck.mode=skip',
    ...
    def power_cycle(params)
      ...
      if @power_port !=nil
        ...
        if @params and @params.key?('sysboot_ctrl') and @params['sysboot_ctrl'].driver_class_name == 'AutomationInterfaceDriver' and params['dut'].name =~ /am654x|dra71x/i
