...
module Equipment
  class LinuxEquipmentDriver < EquipmentDriver
    ...
    @@boot_info = Hash.new('console=ttyS0,115200n8 ').merge(
    {
     ...
     'am572x-idk' => 'console=ttyO2,115200n8  earlyprintk rootwait',
     'am571x-idk' => 'console=ttyO2,115200n8  earlyprintk rootwait',
     ...
     'am437x-idk' => 'console=ttyO0,115200n8 earlyprintk rootwait',
     ...
     'sdp2430' => 'console=ttyO0,115200n8 earlyprintk rootwait',
     'sdp3430' => 'console=ttyO0,115200n8 earlyprintk rootwait',
     'n900' => 'console=ttyO2,57600n8 vram=16M earlyprintk rootwait',
     'ldp3430' => 'console=ttyO2,115200n8 earlyprintk rootwait',
