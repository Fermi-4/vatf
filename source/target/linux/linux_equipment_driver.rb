...
module Equipment
  class LinuxEquipmentDriver < EquipmentDriver
    ...
    @@boot_info = Hash.new('console=ttyS0,115200n8 ').merge(
    {
     ...
     'am3730' => 'console=ttyS0,115200n8 ',
     'am37x-evm' => 'console=ttyS0,115200n8 earlyprintk=serial,ttyS0,115200n8 ',
     'dm3730' => 'console=ttyS0,115200n8 ',
     'dm373x-evm' => 'console=ttyS0,115200n8 ',
     'am1808'  => 'console=ttyS2,115200n8  ',
     'am180x-evm'  => 'console=ttyS2,115200n8  earlyprintk=serial,ttyS2,115200n8 ',
     'am181x-evm'  => 'console=ttyS2,115200n8  ',
     'da850-omapl138-evm'  => 'console=ttyS2,115200n8  mem=32M ',
     'am3517-evm'  => 'console=ttyS2,115200n8  earlyprintk=serial,ttyS2,115200n8 ',
     'dm814x-evm' => 'console=ttyS0,115200n8 mem=166M earlyprintk=serial,ttyS0,115200n8 vram=50M ',
     'dm816x-evm' => 'console=ttyS2,115200n8 mem=166M earlyprintki=ttyS2,115200n8 vram=50M ',
     'am387x-evm' => 'console=ttyS0,115200n8 mem=166M earlyprintk=serial,ttyS0,115200n8 vram=50M ',
     'dm385-evm' => 'console=ttyS0,115200n8  mem=166M earlyprintk=serial,ttyS0,115200n8 vram=50M',
     'ti813x-evm' => 'console=ttyS0,115200n8 mem=166M earlyprintk=serial,ttyS0,115200n8 vram=50M',
     'am389x-evm' => 'console=ttyS2,115200n8 mem=166M earlyprintk=serial,ttyS2,115200n8 vram=50M ',
     'beagleboard' => 'console=ttyS2,115200n8  earlyprintk=serial,ttyS2,115200n8 rootwait',
     'beagleboard-vanilla' => 'console=ttyS2,115200n8  earlyprintk=serial,ttyS2,115200n8 rootwait',
     'am57xx-evm' => 'console=ttyS2,115200n8  earlyprintk=serial,ttyS2,115200n8 rootwait',
     'am572x-idk' => 'console=ttyS2,115200n8  earlyprintk=serial,ttyS2,115200n8 rootwait',
     'am571x-idk' => 'console=ttyS2,115200n8  earlyprintk=serial,ttyS2,115200n8 rootwait',
     'am335x-evm' => 'console=ttyS0,115200n8 earlyprintk=serial,ttyS0,115200n8 rootwait ',
     'am335x-sk' => 'console=ttyS0,115200n8 earlyprintk=serial,ttyS0,115200n8 rootwait',
     'beaglebone' => 'console=ttyS0,115200n8 earlyprintk=serial,ttyS0,115200n8 rootwait',
     'beaglebone-black' => 'console=ttyS0,115200n8 earlyprintk=serial,ttyS0,115200n8 rootwait',
     'omap5-evm' => 'console=ttyS2,115200n8 earlyprintk=serial,ttyS2,115200n8 rootwait',
     'dra7xx-evm' => 'console=ttyS0,115200n8 earlyprintk=serial,ttyS0,115200n8 rootwait',
     'dra72x-evm' => 'console=ttyS0,115200n8 earlyprintk=serial,ttyS0,115200n8 rootwait',
     'am43xx-gpevm' => 'console=ttyS0,115200n8 earlyprintk=serial,ttyS0,115200n8 rootwait',
     'am437x-sk' => 'console=ttyS0,115200n8 earlyprintk=serial,ttyS0,115200n8 rootwait',
     'am43xx-epos' => 'console=ttyS0,115200n8 earlyprintk=serial,ttyS0,115200n8 rootwait',
     'am437x-idk' => 'console=ttyS0,115200n8 earlyprintk=serial,ttyS0,115200n8 rootwait',
     'craneboard' => 'console=ttyS2,115200n8 earlyprintk=serial,ttyS2,115200n8 rootwait nohlt',
     'pandaboard-es' => 'console=ttyS2,115200n8 vram=16M earlyprintk=serial,ttyS2,115200n8 rootwait',
     'pandaboard-vanilla' => 'console=ttyS2,115200n8 vram=16M earlyprintk=serial,ttyS2,115200n8 rootwait',
     'sdp4430' => 'console=ttyS2,115200n8 vram=16M earlyprintk=serial,ttyS2,115200n8 rootwait',
     'sdp2430' => 'console=ttyS0,115200n8 earlyprintk=serial,ttyS0,115200n8 rootwait',
     'sdp3430' => 'console=ttyS0,115200n8 earlyprintk=serial,ttyS0,115200n8 rootwait',
     'n900' => 'console=ttyS2,57600n8 vram=16M earlyprintk=serial,ttyS2,115200n8 rootwait',
     'ldp3430' => 'console=ttyS2,115200n8 earlyprintk=serial,ttyS2,115200n8 rootwait',
