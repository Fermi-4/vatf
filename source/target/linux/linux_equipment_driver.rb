...
module Equipment
  class LinuxEquipmentDriver < EquipmentDriver
    ...
    @@boot_info = Hash.new('console=ttyS0,115200n8 ip=dhcp ').merge(
    {
     ...
     'dm814x-evm' => 'console=ttyO0,115200n8 ip=dhcp  mem=166M earlyprintk vram=50M ',
     'dm816x-evm' => 'console=ttyO2,115200n8 ip=dhcp  mem=166M earlyprintk vram=50M ',
     'am387x-evm' => 'console=ttyO0,115200n8 ip=dhcp  mem=166M earlyprintk vram=50M ',
     'dm385-evm' => 'console=ttyO0,115200n8 ip=dhcp  mem=166M earlyprintk vram=50M',
     'ti813x-evm' => 'console=ttyO0,115200n8 ip=dhcp  mem=166M earlyprintk vram=50M',
     'am389x-evm' => 'console=ttyO2,115200n8 ip=dhcp  mem=166M earlyprintk vram=50M ',
     'beagleboard' => 'console=ttyO2,115200n8 ip=dhcp ',
     'am335x-evm' => 'console=ttyO0,115200n8 ip=dhcp earlyprintk ',
     'am335x-sk' => 'console=ttyO0,115200n8 ip=dhcp earlyprintk ',
     'beaglebone' => 'console=ttyO0,115200n8 ip=dhcp earlyprintk ',
     'beaglebone-black' => 'console=ttyO0,115200n8 ip=dhcp earlyprintk ',
     'omap5-evm' => 'console=ttyO2,115200n8 ip=dhcp ',
     'tci6638-evm' => 'console=ttyS0,115200n8 rootwait=1 earlyprintk', 
     'dra7xx-evm' => 'console=ttyO0,115200n8 ip=dhcp earlyprintk ',
     })
