...
BATCHFILES = ("C:/VGDK/batchfiles")
require "#{BATCHFILES}/scripts/drvif_cfg.rb"
include DrvifCfg
require "#{BATCHFILES}/scripts/evm_start.rb"
include EVMStart
require "#{BATCHFILES}/scripts/xdp_var_set_src_evm_Alt_ST_63.rb"
include XDPVarSetSrcEVM
require "#{BATCHFILES}/scripts/xdp_var_set_tgt_PC.rb"
include XDPVarSetTgtPC
require "#{BATCHFILES}/scripts/dsp_glob_cfg.rb"
include DSPGlobConfig
module Vgdk
#include Log4r

  class VGDKTomahawkClient 
    include Log4r  
    Logger = Log4r::Logger 
