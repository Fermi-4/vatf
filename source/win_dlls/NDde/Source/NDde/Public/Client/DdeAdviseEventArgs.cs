...
namespace NDde.Client
{
    ...
    public sealed class DdeAdviseEventArgs : DdeEventArgs
    {
        ...
        internal DdeAdviseEventArgs(DdemlAdviseEventArgs args)
        {
            _DdemlObject = args;
        }

        /// <summary>
        /// The item name associated with this notification.
        /// </summary>
        public string Item
        {
        ...
        /// <summary>
        /// The format of the data included in this notification.
        /// </summary>
        public int Format
        {
        ...
        /// <summary>
        /// The data associated with this notification or null if this is not a hot advise loop.
        /// </summary>
        public byte[] Data
        {
        ...
        /// <summary>
        /// The text associated with this notification or null if this is not a hot advise loop.
        /// </summary>
        public string Text
        {
            get 
            {
                ...
                {
                    return Encoding.ASCII.GetString(_DdemlObject.Data);
                }
                return null;
            }
        }
