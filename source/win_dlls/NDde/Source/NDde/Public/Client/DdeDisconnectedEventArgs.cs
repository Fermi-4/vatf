...
namespace NDde.Client
{
    ...
    public sealed class DdeDisconnectedEventArgs : DdeEventArgs
    {
        ...
        /// <summary>
        /// A bool indicating whether the client disconnected because of the server.
        /// </summary>
        ...
        /// <summary>
        /// A bool indicating whether the client disconnected because <c>Dispose</c> was explicitly called.
        /// </summary>
        /// <remarks>
