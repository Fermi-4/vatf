...
namespace NDde.Client
{
    ...
    public class DdeClient : IDisposable
    {
        ...
        /// <summary>
        /// The service name associated with this conversation.
        /// </summary>
        ...
        /// <summary>
        /// The topic name associated with this conversation.
        /// </summary>
        ...
        /// <summary>
        /// The DDEML handle associated with this conversation.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// <summary>
        /// A bool indicating whether this conversation is paused.
        /// </summary>
        ...
        /// <summary>
        /// A bool indicating whether the conversation is established.
        /// </summary>
        /// <remarks>
        /// <note type="caution">
        ...
        {
            Poke(item, Encoding.ASCII.GetBytes(data + "\0"), 1, timeout);
        }
        ...
        {
            return Encoding.ASCII.GetString(Request(item, 1, timeout));
        }
        ...
        public virtual void StartAdvise(string item, int format, bool hot, int timeout)
        {
            ThreadStart method = delegate()
            {
                DdemlObject.StartAdvise(item, format, hot, timeout);
            };
        ...
        /// This is thrown when the asynchronous operation could not begin.
        /// </exception>
        public virtual IAsyncResult BeginStartAdvise(string item, int format, bool hot, AsyncCallback callback, object state)
        {
            AsyncResult ar = new AsyncResult(Context);
            ar.Callback = callback;
            ar.State = state;
            ...
            ThreadStart method = delegate()
            {
                ar.DdemlAsyncResult = DdemlObject.BeginStartAdvise(item, format, hot, this.OnStartAdviseComplete, ar);
            };
        ...
        private void OnAdviseReceived(object sender, DdemlAdviseEventArgs internalArgs)
        {
            ...
            if (copy != null)
            {
                copy(this, new DdeAdviseEventArgs(internalArgs));
            }
        }
