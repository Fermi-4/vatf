...
namespace NDde.Server
{
    ...
    public abstract class DdeServer : IDisposable
    {
        ...
        /// <summary>
        /// The context associated with his instance.
        /// </summary>
        ...
        /// <summary>
        /// The service name associated with this server.
        /// </summary>
        ...
        /// <summary>
        /// A bool indicating whether the service name is registered.
        /// </summary>
        ...
        /// </returns>
        /// <remarks>
        /// The default implementation rejects all advise requests.
        /// </remarks>
