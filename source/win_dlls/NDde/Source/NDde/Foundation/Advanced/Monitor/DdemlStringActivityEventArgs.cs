...
namespace NDde.Foundation.Advanced.Monitor
{
    ...
    internal sealed class DdemlStringActivityEventArgs : DdemlEventArgs
    {
        private string                  _Value      = "";
        private DdemlStringActivityType _Action     = DdemlStringActivityType.Create;
        private IntPtr                  _TaskHandle = IntPtr.Zero;

        public DdemlStringActivityEventArgs(string value, DdemlStringActivityType action, IntPtr taskHandle)
        {
            _Value = value;
            _Action = action;
