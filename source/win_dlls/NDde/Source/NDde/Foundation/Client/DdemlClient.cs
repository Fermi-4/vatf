...
namespace NDde.Foundation.Client
{
    ...
    internal class DdemlClient : IDisposable
    {
        ...
        public DdemlClient(string service, string topic) : this(service, topic, DdemlContext.GetDefault())
        {
        }
        ...
        public virtual void Execute(string command, int timeout)
        {
            ...
            byte[] data = System.Text.Encoding.ASCII.GetBytes(command + "\0");
        ...
        public virtual void StartAdvise(string item, int format, bool hot, int timeout)
        {
            ...
            bool ack = Convert.ToBoolean(Resources.DdemlClientAcknowledgeAdvise);
            ...
            public static IntPtr Connect(int instanceId, string service, string topic)
            {
                lock (_Table) 
                {
                    ...
                    if (handle != IntPtr.Zero)
                    {
                        ...
                        _Table.Add(handle, AppDomain.GetCurrentThreadId());
                    }
                    return handle;
                }
            }
        ...
        private sealed class AdviseLoop
        {
            ...
            public IntPtr Process(int uType, int uFmt, IntPtr hConv, IntPtr hsz1, IntPtr hsz2, IntPtr hData, IntPtr dwData1, IntPtr dwData2)
            {
                if (_Client.Advise != null) 
                {
                    ...
                    _Client.Advise(_Client, new DdemlAdviseEventArgs(_Item, _Format, data));
                }
