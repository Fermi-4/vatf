module CmdTranslator
  ...
  @dict_uboot = {
    ...
    'qspi'     => { '0.0' => Hash.new('').merge!({'am43xx-epos' => 'spi-ti-qspi.enable_qspi=1', 'am654x-evm' => '$mtdparts', 'am654x-idk' => '$mtdparts', 'j721e-idk-gw' => '$mtdparts','j721e-evm' => '$mtdparts'})},
    ...
    'primary_bootloader_filename' => { '0.0' => Hash.new('MLO').merge!({'am654x-evm' => 'tispl.bin', 'am654x-idk' => 'tispl.bin', 'j721e-evm' => 'tispl.bin', 'j721e-idk-gw' => 'tispl.bin', 'j721e-evm-ivi' => 'tispl.bin'})},
